...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { documento: @pessoa.documento, endereco_id: @pessoa.endereco_id, nome: @pessoa.nome } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { documento: @pessoa.documento, endereco_id: @pessoa.endereco_id, nome: @pessoa.nome } }
