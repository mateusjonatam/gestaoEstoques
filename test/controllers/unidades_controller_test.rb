...
class UnidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create unidade" do
    assert_difference('Unidade.count') do
      post unidades_url, params: { unidade: { descricao: @unidade.descricao, sigla: @unidade.sigla } }
    end
  ...
  test "should update unidade" do
    patch unidade_url(@unidade), params: { unidade: { descricao: @unidade.descricao, sigla: @unidade.sigla } }
