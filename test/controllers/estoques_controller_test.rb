...
class EstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estoque" do
    assert_difference('Estoque.count') do
      post estoques_url, params: { estoque: { data: @estoque.data, operacao: @estoque.operacao, pessoa_id: @estoque.pessoa_id, produto: @estoque.produto, quantidade: @estoque.quantidade } }
    end
  ...
  test "should update estoque" do
    patch estoque_url(@estoque), params: { estoque: { data: @estoque.data, operacao: @estoque.operacao, pessoa_id: @estoque.pessoa_id, produto: @estoque.produto, quantidade: @estoque.quantidade } }
