...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { grupo: @produto.grupo, nome: @produto.nome, unidade: @produto.unidade } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { grupo: @produto.grupo, nome: @produto.nome, unidade: @produto.unidade } }
